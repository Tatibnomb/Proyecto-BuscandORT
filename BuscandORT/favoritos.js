...
function cargarFavoritos() {
    ...
    favoritos.forEach(favorito => {
        ...
        option.value = favorito; // Asegúrate de que `nombre` es el campo correcto
        option.textContent = favorito;
        selectFavoritos.appendChild(option);
    });
}

document.getElementById("aulasFavoritasMenu").addEventListener("change",()=>mostrarPiso())
function mostrarPiso() {
    const aula = document.getElementById('aulasFavoritasMenu').value;
    let piso;
    let imagen;
